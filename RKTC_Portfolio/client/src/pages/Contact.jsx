...
const CONTACT_INFO = [
  ...
  },
  {
    icon: "✉️",
    label: "Email",
    value: "contact@rktc.com",
    link: "mailto:contact@rktc.com",
  },
  {
    icon: "🕐",
    label: "Working Hours",
    ...
    <div className="bg-[#0d0f14] text-[#f0ede6] font-sans min-h-screen">
      ...
      <div className="px-6 md:px-12 pt-28 pb-14 border-b border-[rgba(201,168,76,0.12)]">
        ...
        <p className="text-[#7a7570] text-[15px] leading-relaxed max-w-md mt-5 fade-up">
          Reach out for premium building materials, project discussions and
          business inquiries. We respond within 24 hours.
        </p>
      </div>
        ...
        <div className="lg:col-span-3">
          {submitted ? (
            ...
            >
              ...
              {/* Error */}
              {error && (
                <div className="mb-4 px-4 py-3 rounded border border-red-500/30 bg-red-500/10 text-red-400 text-[13px]">
                  {error}
                </div>
              )}
        ...
        <div className="bg-[#141720] border border-[rgba(201,168,76,0.1)] rounded overflow-hidden h-[260px] flex items-center justify-center relative">
          <div className="text-center">
            ...
            <p className="text-[13px] text-[#3a3830]">
              Replace with Google Maps embed for your actual location
            </p>
          </div>
